...
const emit = defineEmits(['registerRouter'])
...
<template>
    ...
    <div class="col-md-6">
        <div class="card card-h-100">
            <div class="d-flex card-header justify-content-between align-items-center">
                <h4 class="header-title">Add a new router</h4>
            </div>
            <div class="card-body pt-0">
                <form class="row g-3 needs-validation" novalidate @submit.prevent="saveRouter">
                    <div class="col-12">
                    ...
                    <div class="col-12 mt-4 d-flex justify-content-end">
                        ...
                        <div class="px-1">
                            <button type="submit" class="btn btn-primary" @click="registerRouter">Add Router</button>
                        </div>
                    </div>
                </form>
            </div>
