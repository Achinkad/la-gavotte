        ...
        <div class="col-12">
            <div class="p-title-box">
                <div class="p-title-right">
                    <div class="px-1">
                        <router-link :to="{ name: 'Firewall'}" :title="`Firewall`">
                            <button class="btn btn-primary"><i class="bi bi-arrow-left"></i> Go Back</button>
                        </router-link>
                    </div>
                </div>
                <h2 class="p-title">Create a new firewall rule</h2>
            </div>
        </div>
    </div>
    <div class="row">
                ...
                <div class="col-12">
                    <div class="card card-h-100">
                        <div class="d-flex card-header justify-content-between align-items-center">
                            <h4 class="header-title">Form to create a new firewall rule</h4>
                        </div>
                            ...
                            <label>Select Router</label>
                                ...
                                <div v-if="routerIdentification!='-'" class="row">
                                    ...
                                    <div class="col-6 mt-3">
                                        ...
                                        <input type="text" class="form-control" id="src_port" placeholder="Enter the Src Port" v-model="rule['src-port']" :disabled="protocolNegation=='true' || (rule.protocol!='udp'  && rule.protocol!='tcp' && rule.protocol!='-') ">
                                    </div>
                                    <div class="col-6 mt-3">
                                        <label for="dst_port" class="form-label">Dst-Port</label>
                                        <input type="text" class="form-control" id="dst_port" placeholder="Enter the Dst Port" v-model="rule['dst-port']" :disabled="protocolNegation=='true' || (rule.protocol!='udp'  && rule.protocol!='tcp' && rule.protocol!='-')">
                                    </div>
                                    <div class="col-1 mt-3">
                                        <label class="form-label me-2">Neg. Protocol</label> <br>
                                        <input type="checkbox" class="custom-control-input" @click="editProtocol()">
                                    </div>
                                    <div class="col-11 mt-3" v-if="protocolNegation=='false'">
                                        <label class="form-label">Select Protocol</label>
                                        <select class="form-select" v-model="rule.protocol">
                                            <option value="-" selected hidden disabled>Select a protocol</option>
