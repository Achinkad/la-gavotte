...
const editBridge = () => {
    ...
    if(protocolNegation.value == 'true' && props.rule.protocol!='-'){
        formData.append('protocol', '!'+props.rule.protocol)
    }
    if(protocolNegation.value == 'false' && props.rule.protocol!='-'){
        formData.append('protocol', props.rule.protocol)
    }
        ...
        <div class="card-body pt-0">
            <form class="row g-3" @submit.prevent="editBridge">
                ...
                <div class="col-1 mt-3">
                    <label class="form-label">Negate Protocol</label>
                ...
                <div class="row">
                    <div class="form-check form-switch col-12 mt-3">
                        <label class="form-label" for="flexSwitchCheckDefault"> Disabled</label>
