                        ...
                        <table class="table table-responsive align-middle" >
                            ...
                            <tbody>
                                ...
                                <tr v-for="ospfarea in ospfareas">
                                    ...
                                    <td class="text-center" v-if="ospfarea.disabled=='false'">
                                        <span class="badge badge-success-lighten">Active</span>
                                    </td>
                                    <td class="text-center" v-if="ospfarea.disabled=='true'">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <button class="btn btn-xs btn-light table-button" title="Edit" @click="showAreasOSPF(ospfarea)">
                                                <i class="bi bi-pencil"></i>
                                            </button>
                                            <button class="btn btn-xs btn-light table-button ms-2" title="Delete" @click="deleteAreasOSPF(ospfarea)">
