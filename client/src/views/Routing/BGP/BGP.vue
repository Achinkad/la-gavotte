                        ...
                        <table class="table table-responsive align-middle" >
                            ...
                            <tbody>
                                ...
                                <tr v-for="bgpconnection in bgpconnections">
                                    ...
                                    <td class="text-center" v-if="bgpconnection.disabled==undefined">
                                        <span class="badge badge-success-lighten">Active</span>
                                    </td>
                                    <td class="text-center" v-if="bgpconnection.disabled=='false'">
                                        <span class="badge badge-success-lighten">Active</span>
                                    </td>
                                    <td class="text-center" v-if="bgpconnection.disabled=='true'">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <button class="btn btn-xs btn-light table-button" title="Edit" @click="showConnectionsBGP(bgpconnection)">
                                                <i class="bi bi-pencil"></i>
                                            </button>
                                            <button class="btn btn-xs btn-light table-button ms-2" title="Delete" @click="deleteConnectionsBGP(bgpconnection)">
